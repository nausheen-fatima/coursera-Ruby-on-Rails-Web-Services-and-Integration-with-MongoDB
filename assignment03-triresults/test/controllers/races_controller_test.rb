...
class RacesControllerTest < ActionController::TestCase
  ...
  test "should create race" do
    assert_difference('Race.count') do
      post :create, race: { \: @race.\, city: @race.city, date: @race.date, name: @race.name, state: @race.state, swim_distance: @race.swim_distance, swim_units: @race.swim_units }
    end
  ...
  test "should update race" do
    patch :update, id: @race, race: { \: @race.\, city: @race.city, date: @race.date, name: @race.name, state: @race.state, swim_distance: @race.swim_distance, swim_units: @race.swim_units }
    assert_redirected_to race_path(assigns(:race))
  end
